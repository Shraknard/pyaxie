...
class pyaxie(object):
	...
	def get_qr_code(self):
		...
		img.save('QRCode-' + str(datetime.now()) + '.png')
		return
	...
	def get_profile_data(self):
		...
		r = requests.post(self.url, headers=self.headers, json=body)
		json_data = json.loads(r.text)['data']['profile']
	...
	def get_axie_brief_list(self, ronin_address):
	...
	def claim_slp(self): return
	def rename_axie(self, axie_id): return
	def get_axie_list_from_ronin(self, ronin_address): return
